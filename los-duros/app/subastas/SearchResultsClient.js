...
export default function SubastasPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await fetch("https://das-backend-final.onrender.com/api/auctions/categories/");
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const listRes = await fetch(`https://das-backend-final.onrender.com/api/auctions/?${p.toString()}`);
        ...
        fetched = await Promise.all(
          fetched.map(async (a) => {
            ...
            try {
              const detailRes = await fetch(`https://das-backend-final.onrender.com/api/auctions/${a.id}/`);
              if (detailRes.ok) {
