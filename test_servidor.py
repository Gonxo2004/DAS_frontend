...
class TestSimpleHTTPServer(unittest.TestCase):
    ...
    def test_get_request(self):
        ...
        self.assertIn("<img src=https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbgYSxFe_Lq1HhKUf2z_cdbiCmbFX9Owtyxw&s>", response.text)
        self.assertIn("<p>Web de los Duros.</p>", response.text)
